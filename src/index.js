...
try {
    const contact1 = new Contact(
        "Ojas", "Johar", "Narela", "Bhopal", "Madhya Pradesh", "462001", "9876543210", "helloworld@gmail.com"
    );
    console.log(addressBook.addContact(contact1)); 

    const contact2 = new Contact(
         "Ramu", "Patel", "Narela", "Bhopal", "Madhya Pradesh", "462002", "9564873210", "chandalala@gmail.com"
    )
    ...
    const duplicateContact = new Contact(
        "Ojas", "Johar", "Narela", "Bhopal", "Madhya Pradesh", "462033", "9876559210", "helloworldrt@gmail.com"
    );
