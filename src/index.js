...
try {
    const contact1 = new Contact(
        "Ojas", "Johar", "Bhopal", "India", "Madhya Pradesh", "462001", "9876543210", "helloworld@gmail.com"
    );
    ...
    const duplicateContact = new Contact(
        "Ojas", "Johar", "Bhopal", "India", "Madhya Pradesh", "462033", "9876559210", "helloworldrt@gmail.com"
    );
...
try {
    const invalidContact = new Contact(
        "Ojas", "Joha", "abcd", "In", "I", "109A01", "123445", "invalid-email"
    );
